...
class ChangePicture extends StatefulWidget {
  ...
  const ChangePicture(this.imagedata, {Key key}) : super(key: key);

  @override
  _ChangePicture createState() => _ChangePicture();
}

class _ChangePicture extends State<ChangePicture> {
  bool color;
  File imageprofil;
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  ...
                  apiService.changepicture(imageprofil).then((value) {
                    setState(() {
